...
@section('content')
    <div class="container" id="app">
        ...
        <div class="row gy-5">
            ...
            <input type="text" id="seachInput" onkeyup="filterGenres()" placeholder="Filter by genre.." title="Type in a genre name">
            <table id="artistsTable">
                ...
                <tr>
                    ...
                    <td><a href="{{ $artist['external_urls']['spotify'] }}" target="_blank">Play artist</a></td>
                </tr>
                @endforeach
            </table>
